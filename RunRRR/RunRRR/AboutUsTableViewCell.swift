...
class AboutUsTableViewCell: UITableViewCell {
    ...
    func setupView(){
        ...
        aboutUsTextView.text = "Hi, 我們是ColdeGarage, 位於資電館822屬於清大電機的Maker Space 我們致力於提倡電機系的自造風氣，有想做的東西嗎?來就對了。至於這個APP，是由一位上古英文營神獸大佬所突然靈光乍現，對營隊活動有所不滿，於是他施展了封印黑魔法召喚一群沒有能力的召喚師。但是這群召喚師們非常爭氣，努力向上，最後完成了這個APP，也改善了這個營隊一開始不方便的地方。如果你對任何活動有不滿或有意見，也歡迎模仿上古英文營神獸大佬來組建自己的團隊，為自己的系上或活動來努力吧!加油~各位年輕的召喚師們!未來是你們的!\n\n開發者們的一句話：\n洪繹峻：宣傑徵女友，cos魯到朽，快逃Rrr，一起變朋友！\n楊淳佑：爆肝人生。\n黃宣傑(Jacky)：被21囉 也要繼續打扣 希望能提前竣工ˊˋ\n謝承翰(QMo)：好想出去玩!\n陳玉璇：我會魯4/3輩子QQ\n曾筱茵：打完扣就可以睡了嗎\n陳邦亢：一時衝動就入了這個坑，超嗨der！\n楊靜璇：想不開就是成功的開始ㄎㄎ\n魏嘉緯：抓神獸囉！"

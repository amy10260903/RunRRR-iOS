  ...
  //  let emergencyInfoTextView = UITextView()
    ...
    func setupView(){
       ...
       // contentView.addSubview(emergencyInfoTextView)
        ...
        contentView.addSubview(sosButton)
       ...
       // contentView.addConstraintWithFormat(format: "H:|-20-[v0]-20-|", views: emergencyInfoTextView)
        contentView.addConstraintWithFormat(format: "V:[v0]-5-[v1(20)]-5-[v2]-5-|", views: titleBarView,sosButton,emergencyInfoCollectionView)
        contentView.addConstraintWithFormat(format: "H:|-20-[v0]-20-|", views: emergencyInfoCollectionView)
        contentView.addConstraintWithFormat(format: "H:[v0(60)]", views: sosButton)
        addConstraint(NSLayoutConstraint(item: sosButton, attribute: .centerX, relatedBy: .equal, toItem: self, attribute: .centerX, multiplier: 1, constant: 0))
    ...
    func setupTitleBarView(){
        titleBarView.backgroundColor = UIColor(red: 245/255, green: 160/255, blue: 54/255, alpha: 1)
        ...
        sosButton.setTitleColor(.black, for: .normal)
    ...
    func hideContent(_ isHidden:Bool){
        self.sosButton.isHidden = isHidden
    }
